            ...
            <>
              {!user ? (
                ...
                <section className="create-section card">
                  <h2 className="section-title">Create a Topic</h2>
                  {createOpen ? (
                    <form onSubmit={handleCreateTopic} style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                      ...
                      <div style={{ display: 'flex', gap: '0.5rem' }}>
                        <button 
                          type="submit" 
                          className="btn-primary" 
                          disabled={hasFilteredWords || !stance}
                          style={{ flex: 1 }}
                        >
                          Create Topic
                        </button>
                    ...
                    <button 
                      ...
                      className="btn-primary"
                      disabled={!profile?.homebase_set}
                    >
                      {profile?.homebase_set ? '+ Create New Topic' : 'Set Homebase First'}
                    </button>
                  )}
                </section>
              )}
              ...
              <section className="feed-section">
                <div className="feed-header">
                  <h2 className="section-title">Topic Feed</h2>
